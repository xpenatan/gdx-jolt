...
public class TransformedShapeCollector extends NativeObject {
    ...
    @org.teavm.jso.JSBody(params = {"this_addr", "inUserData"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.TransformedShapeCollector);jsObj.SetUserData(inUserData);")
