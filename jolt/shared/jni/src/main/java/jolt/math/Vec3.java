...
public final class Vec3 extends NativeObject {
    ...
    public static long internal_native_sDifferenceOfProducts_addr(long inA_addr, long inB_addr, long inC_addr, long inD_addr) {
        return jolt.math.natives.JNI_Vec3.internal_native_sDifferenceOfProducts_addr(inA_addr, inB_addr, inC_addr, inD_addr);
    }
    ...
    public static long internal_native_CrossPrecise_addr(long this_addr, long inRHS_addr) {
        return jolt.math.natives.JNI_Vec3.internal_native_CrossPrecise_addr(this_addr, inRHS_addr);
    }
    ...
    public static float internal_native_ReduceSum(long this_addr) {
        return jolt.math.natives.JNI_Vec3.internal_native_ReduceSum(this_addr);
    }
